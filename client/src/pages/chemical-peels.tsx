...
const ChemicalPeels = () => {
  ...
  const process = [
    { step: 1, title: "Skin Analysis", description: "Comprehensive skin assessment" },
    { step: 2, title: "Preparation", description: "Pre-treatment skin preparation" },
    { step: 3, title: "Peel Application", description: "Customized chemical peel treatment" },
    { step: 4, title: "Recovery Care", description: "Post-peel care instructions" }
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl lg:text-2xl mb-8 text-blue-100 max-w-3xl mx-auto">
              Customized chemical peels to improve skin texture, reduce acne scars, and achieve radiant skin
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 mb-20">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground mb-6">
                Our chemical peel treatments are carefully customized to your skin type and concerns. From light peels for maintenance to deeper peels for dramatic improvements, we offer the perfect solution for your skin goals.
              </p>
              <p className="text-lg text-muted-foreground mb-8">
                Using medical-grade acids including glycolic, salicylic, and TCA, our peels effectively address acne, hyperpigmentation, fine lines, and uneven texture for a smoother, more radiant complexion.
              </p>
            ...
            >
              <img
                ...
                alt="Chemical peel treatment application"
          ...
          >
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Discover the power of customized chemical peels for healthier, more radiant skin.
            </p>
